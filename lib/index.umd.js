(function (global, factory) {
	typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('core-js/modules/es6.set.js'), require('core-js/modules/es6.string.iterator.js'), require('core-js/modules/es6.object.to-string.js'), require('core-js/modules/es6.array.iterator.js'), require('core-js/modules/web.dom.iterable.js'), require('core-js/modules/es6.regexp.to-string.js'), require('core-js/modules/es6.object.get-prototype-of.js'), require('core-js/modules/es6.function.name.js'), require('core-js/modules/es6.regexp.match.js'), require('core-js/modules/es6.regexp.replace.js'), require('core-js/modules/es7.array.includes.js'), require('core-js/modules/es6.symbol.js'), require('core-js/modules/es6.object.keys.js')) :
	typeof define === 'function' && define.amd ? define(['exports', 'core-js/modules/es6.set.js', 'core-js/modules/es6.string.iterator.js', 'core-js/modules/es6.object.to-string.js', 'core-js/modules/es6.array.iterator.js', 'core-js/modules/web.dom.iterable.js', 'core-js/modules/es6.regexp.to-string.js', 'core-js/modules/es6.object.get-prototype-of.js', 'core-js/modules/es6.function.name.js', 'core-js/modules/es6.regexp.match.js', 'core-js/modules/es6.regexp.replace.js', 'core-js/modules/es7.array.includes.js', 'core-js/modules/es6.symbol.js', 'core-js/modules/es6.object.keys.js'], factory) :
